  ...
  return (
    <form className="card stack" style={{ maxWidth: 640 }} onSubmit={submit}>
      ...
      <div className="grid-2">
        ...
        <label className="field"><span className="label">Regningen lages den (dag i måneden)</span><input className="input" type="number" min={1} max={28} value={f.billing_day} onChange={e => set({ billing_day: Number(e.target.value) })} /></label>
